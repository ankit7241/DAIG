	...
	return (
		<div className="flex flex-col pt-28 mb-32">
			<div className="flex flex-col pl-5 gap-7 lg:pl-24">
				<div className="Inter text-[3.562vw] text-start font-bold bg-trainAIGradient text-transparent bg-clip-text lg:text-2xl">
					END TO END ENCRYPTED
				</div>
				<div className="Inter text-white text-[6.107vw] text-start font-extrabold lg:text-[42px]">
					ROAD MAP
				</div>
				<div className="Inter text-white text-[4.071vw] text-start font-normal lg:text-2xl lg:w-2/5">
			...
			<div className="flex flex-col gap-[12.285vw] mt-[12.570vw]">
				<div className="flex pl-[3.053vw] w-full gap-[14.249vw]">
					<div className="flex flex-col gap-[4.071vw] items-start w-full ml-[9.415vw] pl-[3.308vw] pt-[2.435vw] pb-[7.476vw]">
						<div className="flex items-center gap-[1.117vw]">
							...
							<div className="Inter text-roadmapFont text-[1.329vw] text-start font-normal">
								Marketing
							</div>
						</div>
						<div className="Inter text-roadmapFont text-[1.329vw] text-start font-bold">
							Marketing Website and whitepaper launch
						</div>
						<div className="Inter text-roadmapFont text-[1.181vw] text-start font-normal w-9/12">
				...
				<div className="flex pl-3 w-full gap-14">
					<div className="flex flex-col gap-4 items-start w-full ml-[9.415vw] pl-[3.308vw] lg:pt-[2.435vw] lg:pb-[7.476vw]">
						...
						<div className="Inter text-roadmapFont text-[1.181vw] text-start font-normal w-4/12">
